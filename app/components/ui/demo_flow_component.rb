module Ui
  class DemoFlowComponent < ViewComponent::Base
    STEPS = [
      ...
      { num: 4, label: "Gate Locks", endpoint: "n/a", code: "423 Locked", status: :active, time: "1m ago" },
      { num: 5, label: "Incident Created", endpoint: "POST /api/incidents", code: "201 Created", status: :pending, time: "pending" },
      { num: 6, label: "View Runbook", endpoint: "GET /runbooks/gameday", code: "200 OK", status: :pending, time: "pending" }
    ].freeze
  end
end
